                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center">
                                ...
                                />
                                <label htmlFor="live" className="ml-3 block text-sm font-medium text-gray-700">
                                    Live Shows
                                </label>
                            </div>
                            <div className="flex items-center">
                                <input
                                    ...
                                    name="eventType"
                                    value="dj"
                                    checked={eventType === 'dj'}
                                    onChange={(e) => setEventType(e.target.value)}
                                    className="h-4 w-4 text-green-600 focus:ring-green-500 border-gray-300"
                                />
                                <label htmlFor="dj" className="ml-3 block text-sm font-medium text-gray-700">
                                    DJ Sets
                                </label>
                            </div>
                        </div>
